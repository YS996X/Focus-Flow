...
import { Clock, BarChart2, Play, Pause, RotateCcw, Users, Music } from "lucide-react"
      ...
      <main className="flex-1 container max-w-4xl mx-auto px-4 py-8">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          <div className="bg-gray-900/50 rounded-xl p-6">
            ...
            <p className="text-gray-400 mb-8">Use the Pomodoro technique to stay focused</p>

            <div className="bg-gray-900/50 rounded-xl p-8 w-full max-w-md flex flex-col items-center mx-auto relative">
              {/* Circular progress indicator */}
              <div className="absolute inset-0 flex items-center justify-center">
                <div className="w-[220px] h-[220px] rounded-full bg-gray-800/30">
                  <div
                    className="w-full h-full rounded-full bg-purple-600/20 flex items-center justify-center"
                    style={{
                      clipPath: `circle(${calculateMainTimerPercentage()}% at center)`,
                    }}
                  />
                </div>
              </div>

              <div className={cn("text-[8rem] font-bold tracking-tighter leading-none mb-8 z-10", anton.className)}>
                {formattedTime}
              </div>
              ...
              <div className="grid grid-cols-3 gap-2 w-full bg-gray-800/50 p-1 rounded-lg z-10">
                <Button
            ...
            {/* Visual Timer - Moved from Tasks page */}
            <div className="mt-8">
            ...
            {/* Time Estimator - Moved from Tasks page */}
                ...
                <div className="flex items-center justify-between bg-gray-700/30 p-3 rounded-lg">
                  ...
                  <div className="flex items-center gap-1">
                    <input
                      ...
                      className="w-16 p-1 bg-gray-800 rounded-md text-center focus:outline-none border border-gray-700"
                    />
          ...
          <div className="space-y-6">
            {/* Focus Insights - Moved from Tasks page */}
            <div className="bg-gray-900/50 rounded-xl p-6">
              ...
              <div className="space-y-3">
                ...
                <div className="bg-gray-700/30 p-3 rounded-lg">
                  ...
                  <div className="grid grid-cols-2 gap-2">
                    <div className="bg-gray-600/50 p-2 rounded-lg text-center">
            ...
            {/* Body Doubling - Moved from Tasks page */}
            <div className="bg-gray-900/50 rounded-xl p-6">
              <h3 className="text-lg font-medium mb-3 flex items-center">
