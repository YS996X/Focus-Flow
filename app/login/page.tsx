...
export default function LoginPage() {
  ...
  // Preload key pages on component mount
  useEffect(() => {
    // Preload the loading page and home page in advance
  ...
  const handleGoogleLogin = async () => {
    try {
      ...
      // Navigate to loading page instead of home
          ...
          <div className="flex flex-col items-center justify-center min-h-screen p-4 text-center">
            <div className="w-full max-w-md space-y-8">
              <div className="space-y-2">
                <h1 className={cn("text-4xl font-bold tracking-tight", anton.className)}>
                  Focus Flow
                </h1>
